      ...
      >
        <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden md:inline-block px-5 py-2 border border-zenithGold text-zenithGold rounded-md font-semibold hover:bg-zenithGold hover:text-black transition"
          >
            All Our Links
          </a>
